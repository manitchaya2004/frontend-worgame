...
      // 1 & 2. ดึงข้อมูล player_resource เดิมมาเพื่ออัปเดตเงิน และ Potion Slot (ถ้าเคลียร์ด่านครั้งแรก)
...
      if (nextStage) {
        // 🌟 FIX: เปลี่ยนจาก .upsert() เป็น .select() แล้วค่อย .insert() / .update() เพื่อเลี่ยงปัญหา id: null
