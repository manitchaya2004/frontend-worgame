...
const SingleSlot = ({ item, index, isLocked, onSelect, totalModifier, isDisabled }) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", position: "relative", padding: "2px", boxSizing: "border-box" }}>
      <div
        style={{
          width: "100%",
          height: "100%",
          ...
          {item && !isLocked && (
            <motion.div
              ...
              style={{
                ...
                color: isPoisoned ? "#1b5e20" : isStunned ? "#2c3e50" : "#3e2723",
                cursor: (isDisabled || isStunned) ? "not-allowed" : "pointer",
                position: "relative",
                pointerEvents: (isDisabled || isStunned) ? "none" : "auto",
                boxShadow: isPoisoned ? "0 0 8px #2ecc71" : "0 4px 8px rgba(0,0,0,0.3)"
              }}
            >
              ...
              {item.status && (
                <div style={{
                  ...
                  fontSize: "9px", color: "#fff", fontWeight: "bold", zIndex: 10,
              ...
              <div style={{ position: "absolute", top: "4px", right: "4px", zIndex: 5 }}>
                {isPoisoned && (
                  <motion.div 
                    animate={{ y: [0, -2, 0] }}
...
export const InventorySlot = ({ inventory, onSelectLetter, playerSlots = 10, playerStats = { STR: 10 }, gameState }) => {
