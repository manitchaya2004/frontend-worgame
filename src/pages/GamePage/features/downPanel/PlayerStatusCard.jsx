...
const MiniBuffIcon = ({ effectName, isActive }) => {
  ...
  return (
    <div style={{
      ...
      fontSize: "14px", // ขยายไอคอนข้างในจาก 11px
...
export const PlayerStatusCard = ({ onHeal, onCure, onReroll }) => {
  ...
  // 🌟 Logic เพื่อสร้าง Array ของไอคอนทั้งหมด โดยอิงจาก deck_list รวม
    ...
    <div style={{ 
      ...
      >
        <div style={{
          ...
          borderRadius: "6px",
          padding: "4px", // ลด padding ลงเพื่อไม่ให้เบียดตอนไอคอนใหญ่ขึ้น
          display: "flex",
          justifyContent: "center", 
          alignItems: "center",
